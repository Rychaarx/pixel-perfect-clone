...
const HeroSlider = ({ items = [] }: HeroSliderProps) => {
  ...
  if (items.length === 0) {
    return (
      <div className="relative h-[50vh] min-h-[300px] md:h-[60vh] md:min-h-[400px] bg-secondary flex items-end p-4 md:p-12">
        <div>
          <h1 className="font-display text-xl md:text-5xl text-foreground mb-3 tracking-wide">CINE CLOUD</h1>
  ...
  return (
    <div className="relative h-[45vh] min-h-[280px] sm:h-[50vh] sm:min-h-[340px] md:h-[60vh] md:min-h-[420px] lg:h-[70vh] lg:min-h-[500px] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 md:p-12">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h1 className="font-display text-lg sm:text-2xl md:text-5xl text-foreground mb-2 tracking-wide">
