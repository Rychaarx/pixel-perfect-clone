  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="px-4 pt-12 pb-6">
        <h1 className="font-display text-3xl text-foreground tracking-wider mb-6">SEARCH</h1>
      ...
      <div className="px-4">
        {query.trim() === "" ? (
          <div className="text-center py-20">
            ...
            <p className="text-muted-foreground text-sm">Search for your favorite movies</p>
          </div>
        ) : filtered.length === 0 ? (
          <div className="text-center py-20">
